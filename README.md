...
画面上部で「初心者向け」と「詳細入力」を切り替えられます。どちらのモードでも同じ入力内容を共有するため、初心者向けで大枠を作ってから詳細入力で微調整できます。

### 初心者向け

技術名や画面構成が分からない人でも使いやすいように、以下の流れで入力します。
...
開発経験がある人や、Codexへの指示を細かく調整したい人向けの入力モードです。
